...
-- ---------------------------------------------------------------------
insert into routing_rules (id, course_id, category, department_id, ack_sla_minutes, resolve_sla_minutes, requires_photo, requires_member_no)
values
  ('f0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'pace_of_play',        'd0000000-0000-0000-0000-000000000004', 10, 30,  false, false),
  ('f0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000001', 'course_maintenance',  'd0000000-0000-0000-0000-000000000001', 15, 240, false, false),
  ('f0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000001', 'cart_issue',          'd0000000-0000-0000-0000-000000000002', 10, 45,  false, false),
  ('f0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000001', 'pro_shop',            'd0000000-0000-0000-0000-000000000003', 15, 60,  false, false),
  ('f0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'f_and_b',             'd0000000-0000-0000-0000-000000000005', 10, 30,  false, true),
  ('f0000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000001', 'restroom_facilities', 'd0000000-0000-0000-0000-000000000001', 20, 120, false, false),
  ('f0000000-0000-0000-0000-000000000007', 'c0000000-0000-0000-0000-000000000001', 'practice_facility',   'd0000000-0000-0000-0000-000000000003', 30, 240, false, false),
  ('f0000000-0000-0000-0000-000000000008', 'c0000000-0000-0000-0000-000000000001', 'safety',              'd0000000-0000-0000-0000-000000000007', 5,  30,  false, false),
  ('f0000000-0000-0000-0000-000000000009', 'c0000000-0000-0000-0000-000000000001', 'caddie_valet',        'd0000000-0000-0000-0000-000000000006', 10, 30,  false, false),
  ('f0000000-0000-0000-0000-000000000010', 'c0000000-0000-0000-0000-000000000001', 'needs_review',        'd0000000-0000-0000-0000-000000000007', 15, 120, false, false)
on conflict (id) do nothing;
