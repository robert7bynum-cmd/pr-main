...
await db.exec(`create role anon; create role authenticated; create role service_role;
  ...
  create table auth.users (id uuid primary key, instance_id uuid, email text, aud text,
    role text, created_at timestamptz default now(), updated_at timestamptz default now());
